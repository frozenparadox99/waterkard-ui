...
class PdfInvoiceApi {
  ...
  static Widget buildInvoiceInfo(InvoiceInfo info) {
    ...
    return Column(
      ...
      children: List.generate(titles.length, (index) {
        ...
        return buildText(title: title, titleStyle: TextStyle(fontWeight: FontWeight.bold), value: value, width: 200);
      }),
    );
  }
  ...
  static Widget buildFooter(Invoice invoice) => Column(
    ...
    children: [
      ...
      SizedBox(height: 1 * PdfPageFormat.mm),
      buildSimpleText(title: 'Payment Info', value: invoice.supplier.paymentInfo),
    ],
  );
