...
class NewCustomerPaymentList extends StatefulWidget {
  const NewCustomerPaymentList({Key key}) : super(key: key);

  @override
  _NewCustomerPaymentListState createState() => _NewCustomerPaymentListState();
}

class _NewCustomerPaymentListState extends State<NewCustomerPaymentList> {
  ...
  void getAllCustomerDeposits () async {
    ...
    if(id!=null){
      String apiURL =
          "$API_BASE_URL/api/v1/vendor/customer/all-payments?vendor=$id";
      print(apiURL);
      ...
      if(decodedJson["success"]!=null && decodedJson["success"] == true && decodedJson["data"]!=null && decodedJson["data"]["customers"]!=null){
        ...
        setState(() {
          totalPay = "${decodedJson["data"]["totalBalance"]}";
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  SizedBox(height: 10,),
                  Center(
                    child: Text("Total balance: $totalPay", style: TextStyle(color: Colors.white, fontSize: 18),),
                  )
                ],
              ),
            ),
