...
class DepositUpdate extends StatefulWidget {
  @override
  _DepositUpdateState createState() => _DepositUpdateState();
}

class _DepositUpdateState extends State<DepositUpdate> {
          ...
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 10,),
                Center(
                  child: Text("Deposit: Rs.5000", style: TextStyle(color: Colors.white, fontSize: 18),),
                )
              ],
            ),
          ),
                            ...
                            CardSettingsSection(
                              ...
                              children: <CardSettingsWidget>[
                                ...
                                CardSettingsButton(
                                  onPressed: (){
                                    Navigator.pushReplacement(
                                        context, MaterialPageRoute(builder: (context) => DepositeList()));
                                  },
                                  label: 'CANCEL',
                                  isDestructive: true,
