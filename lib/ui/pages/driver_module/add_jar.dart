...
class DriverAddOrder extends StatefulWidget {
  @override
  _DriverAddOrderState createState() => _DriverAddOrderState();
}

class _DriverAddOrderState extends State<DriverAddOrder> {
  String selection;
