...
class TotalInventoryRemovePage extends StatefulWidget {
  @override
  _TotalInventoryRemovePageState createState() => _TotalInventoryRemovePageState();
}
  ...
  void getTotalInventory () async {
    ...
    if(id!=null){
      ...
      if(decodedJson["success"]!=null && decodedJson["success"] == true && decodedJson["data"]!=null && decodedJson["data"]["totalInventory"]!=null){
        List<dynamic> receivedProducts = decodedJson["data"]["totalInventory"]["removedStock"];
