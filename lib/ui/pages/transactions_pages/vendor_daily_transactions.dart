...
class VendorDailyTransactionList extends StatefulWidget {
  final String customerId;
  VendorDailyTransactionList({@required this.customerId});

  @override
  _VendorDailyTransactionListState createState() => _VendorDailyTransactionListState();
}

class _VendorDailyTransactionListState extends State<VendorDailyTransactionList> {
